...
describe("msg", () => {
  ...
  it("has every code from DESIGN §11, plus SPOOF_REPO (T2.5) IMPERSONATION (E4), NOT_PAYABLE (E5), RESOLVE_FAILED and EXECUTION_FAILED (E7), UNKNOWN_STATE and VERIFY_FAILED (E11)", () => {
    expect(Object.keys(MESSAGES)).toHaveLength(45);
  });

...
# @endcredits-demo/unclaimed-rehearsal-1
...
```js
const { formatUnclaimedRehearsal1 } = require('@endcredits-demo/unclaimed-rehearsal-1');
formatUnclaimedRehearsal1(1.5) // '1.50 USDC unclaimed'
```

    ...
    >
      ...
      >
        ...
        <g className="ec-package">
          <path d="m182 30 76-23 73 27-77 26Z" fill="#ADF3C0" />
          <path d="M182 30v76l72 31V60Z" fill="white" />
          <path d="m254 60 77-26v74l-77 29Z" fill="#F7F7EF" />
          <path d="m216 20 74 27v27l-17 6V53L200 25" />
          <path d="m199 64 24 11m-24 0 15 7m60 21 33-12" />
        </g>
        <path d="m92 27 4 16 16 4-16 5-4 16-5-16-16-5 16-4Z" fill="#ADF3C0" />
        ...
        <g transform="rotate(-16 161 225)">
          ...
          <circle cx="149" cy="212" r="16" fill="#ADF3C0" />
          <circle cx="149" cy="212" r="5" fill="#20261F" />
          <path
        ...
        <g transform="translate(222 350)">
          <path d="M-8 23v21c0 13 27 23 60 23s60-10 60-23V23" fill="#20261F" />
          ...
          <ellipse cx="40" cy="0" rx="60" ry="23" fill="#ADF3C0" />
        ...
        <g transform="rotate(-25 120 407)">
          <ellipse cx="126" cy="408" rx="49" ry="25" fill="#20261F" />
    ...
    <svg viewBox="0 0 160 120" fill="none" aria-hidden="true">
      <g stroke="currentColor" strokeWidth="2.5" strokeLinejoin="round">
        <path
          ...
          fill="#F7F7EF"
        />
        <path d="M12 49h136l-11 53H23Z" fill="#ADF3C0" />

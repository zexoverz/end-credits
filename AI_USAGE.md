...
| frontend T8.4 landing revamp | `app/landing/*`, `components/landing/experience.tsx`, `lib/copy/experience.ts`; simplified hero, explicit AI session flow, sourced OSS value and funding gap, ecosystem examples, MotionSites-inspired window motion | pending human review; desktop/mobile browser checks in progress |
